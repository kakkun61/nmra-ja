# S-9.2.2 Configuration Variables For Digital Command Control {#configuration-variables-for-digital-command-control}
...
#### Configuration Variable 3: Acceleration Rate {#cv-3-acceleration-rate}
